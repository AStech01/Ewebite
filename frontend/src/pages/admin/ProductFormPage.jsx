    ...
    <div className="max-w-3xl mx-auto p-8 bg-white shadow-md rounded-2xl mt-10">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
        ...
        <div>
          ...
          {image && <img src={image} alt="preview" className="mt-3 h-32 object-contain border rounded" />}
        </div>
        ...
        <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg">{id ? 'Update' : 'Add'} Product</button>
      </form>
    </div>
  );
}
